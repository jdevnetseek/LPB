...
{
    require_once ABSPATH .'wp-content/plugins/'.LPB_FOLDER_NAME.'/view/wp-page-list.php';
}

function instructions()
{
	include_once ABSPATH .'wp-content/plugins/'.LPB_FOLDER_NAME.'/view/instructions.php';
}
...
function krSetup(){
  ...
  require_once $plugin_path.'admin-setup-tabs.php';  
}
